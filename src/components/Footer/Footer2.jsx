...
import Linkedin  from "../Footer/socialmedia/Linkedin.svg"
import Facebook from "../Footer/socialmedia/Facebook.svg"
import Youtube  from "../Footer/socialmedia/Youtube.svg"
import Twitter from "../Footer/socialmedia/Twitter.svg"
import instagram  from "../Footer/socialmedia/Instagram.svg"

function Footer2() {
    return (
        <div className=''>
            <div className="w-full h-9 md:h-full bg-teal-800">
                <div className=" ml-[88px] md:ml-[550px] pt-2.5 md:hidden md:pt-4 w-[184.86px] h-[15.89px]   text-center text-white text-xs md:text-xl  font-bold font-['Arial'] leading-none">Contact us</div>
            </div>
            ...
            <div className="w-full h-[82px] md:h-full bg-teal-800">
                ...
                <div className='hidden md:block'>
                    ...
                    <div className='flex pb-2'>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[150px]">Privacy Statement</div>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[50px]">Terms & Conditions</div>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[50px]">Terms & Conditions</div>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[50px]">Cookie Policy/Settings</div>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[50px]">Accessibility Statement</div>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[50px]">Sitemap</div>
                        <div className=" text-neutral-400  text-[11px] font-normal font-['Arial'] underline ml-[50px]">© 2023 Zegju. All Rights Reserved.</div>
                    </div>
                </div>
                ...
                <div className='md:hidden'>
                    <div className='ml-8 mt-2 md:ml-[400px]  md:mt-6  mb-4'>
                        <div className="w-[309.82px] md:w-[1290.82px] h-[23.46px] relative border-t border-neutral-400">
